...
('Strangers',344,'2022-04-07',1,1,'Strangers.jpg','Was originally written sometime in 2018 or earlier since it was first released on Sad Music for Sad People'),
...
('Inbred',287,'2021-04-23',2,1,'Inbred.jpg','Someone asked what some lyric meant and she said she was high or something and so it didnt really have meaning????? (source was probably from deleted tumblr, so idk specifics)'),
...
('White Light',216,'2018-07-28',NULL,2,'White_Light.jpg','Used to be on Spotify until sometime in Summer 2023 (last streamed July 1st, 2023)'),
('Just Snorted a Pill',207,'2017-01-01',NULL,7,'Witchcest.jpg','Spotify says 1/1/17, but Youtube auto says 9/28/2017?????'),
...
('Florida Heat',183,'2018-10-26',6,2,'Nightmares.jpg','"Starting off the typical “boy meets girl” story, two young wayward adults fall into each other’s lives. They both know they’re unhealthy, but they’re so madly in love nothing matters anyways."'),
('Hitch Party',146,'2018-10-26',6,2,'Nightmares.jpg','"The two of them start to fall down the rabbit hole of sleazy parties and the crime underworld, putting a strain on their relationship that neither of them want to acknowledge."'),
('Nightmares',174,'2018-10-26',6,2,'Nightmares.jpg','"The relationship gets worse and worse, with him starting to actually abuse her and fall deeper and deeper into the mess he’s made of both of them. She doesn’t want to leave him, but she’s scared of where they’re headed."'),
('The Wake',133,'2018-10-26',6,2,'Nightmares.jpg','"Finally the love story comes to an end. After dirty fights and hard drugs that he can’t recover from, he winds up wasting away with his lover right beside him until she buries him."'),
('Strangers - Demo',231,'2018-09-15',7,2,'Sad_Music_for_Sad_People.jpg','"Strangers, the opening demo track from “Sad Music for Sad People”, tells a bittersweet love story about a Stockholm syndrome-stricken victim of a cannibal kidnapper."'),
('Cold Food',193,'2018-09-15',7,2,'Sad_Music_for_Sad_People.jpg','"Cold Food depicts what it feels like to love someone suffering with extreme depression. It’s hard to save someone who needs it when you can barely save yourself."'),
('Stomping Ground',260,'2018-09-15',7,2,'Sad_Music_for_Sad_People.jpg','"Sometimes people f*ck you over and pretend like it never happened. And it’s not your job to forgive them, or to bring them to justice. But sometimes you just want to, and no one can stop you."'),
('Vacancy',262,'2018-09-15',7,2,'Sad_Music_for_Sad_People.jpg','"This track is just a love story between a high schooler and a man they met who lives in a motel by the interstate."'),
('A House in Nebraska - Demo',372,'2018-09-15',7,2,'Sad_Music_for_Sad_People.jpg',''),
('S.M.F.S.P.',110,'2018-09-15',7,2,'Sad_Music_for_Sad_People.jpg','"All I do is listen to other people’s sad music and then write my own. That’s how it is and that’s how I like it I suppose."'),
...
('famous last words (an ode to eaters)',205,'2022-11-23',NULL,1,'famous_last_words.png','CHECK IF SOUNDS THE SAME AS OTHER - POSSIBLY MERGE, otherwise change parent FK'),
...
('Earnhardt',261,'2021-05-19',2,1,'Earnhardt.jpg','Released on Inbred CD (CHECK DATE, but also keep soundcloud posting date for historical records)'),
...
('crying during sex (demo)',272,'2020-05-10',NULL,1,'crying_demo.jpg','Samples Hello Neighbor OST - Nostalgia'),
...
'),
('new mexico dreaming (co-prod. edith underground)',234,'2021-12-31',NULL,4,'new_mexico.jpg','According to Tumblr it is from the miss anhedonia days'),
...
('matriach1',674,'2022-08-10',NULL,5,'matriach1.jpg','Noticed on 2/11/24 that it''s not on ashemdaiii''s Soundcloud anymore'),
('000',392,'2023-06-20',NULL,5,'000.jpg','Was called v_t2'),
('001',244,'2023-08-08',NULL,5,'001.jpg',''),
('002',298,'2023-08-09',NULL,5,'002.jpg','"sample: caught in time, so far away - you''ll never get to heaven"'),
...
From Miss Anhedonia era'),
('A long, unfortunate while (demo)',331,'2021-04-14',NULL,1,'long_unfortunate_while.jpg','tumblr - Allegedly cut from Inbred'),
...
('waco, texas (demo)',372,'2021-03-31',NULL,1,'waco_texas.jpg','20 minutes & on b sides tumblr (have TWO VERSIONS)'),
...
('Independence Day (prod. Yah Wav)',174,'2019-09-29',NULL,NULL,'','Tracker from Lanaboards says "September 29, 2019" ??'),
('Your Jacket',247,'2020-02-17',NULL,1,'','Tracker from Lanaboards says Feb 17, 2020, and "First appeared online via YouTube, it was posted by a friend of Hayden, Malcolm MacMaster."'),
('rabbit hole',63,'2018',NULL,2,'rabbit_hole.jpg','Got it from file titled "Rabbit Hole (Antebellum demo)"'),
...
('Embarrassing (Ellis Cover)',171,'2020',NULL,1,'embarassing.jpg','Embarrassing didn''t come out until 2020, so she couldn''t have covered it until then (unless she is friends with her & heard it early)'),
...
('my heart will go on (cover)',75,'2020',NULL,1,'','Audio ripped from a vid of her singing in her Indiana church in a robe'),
('American Teenager (B sides)',102,'2022',NULL,1,'American_Teenager_B_sides.jpg','I believe this may be a mashup of MULTIPLE demos'),
('Tammy Faye (Nicole Dollanganger Cover)',225,'2020',NULL,1,'waco_texas.jpg','Gotta be old as bones cuz from reading Lanaboards it seems at least from 2020 (if not earlier) and was lost media for a long time'),
('Scarlet Letter',104,'2020-11-08',NULL,1,'','Posted with the captions "Are you coming to the chapel?" on Twitter and "Welcome to the chapel ♡" on Instagram on 11/8/2020 by Daisy Cain (@missdaisycain) with a video seemingly filmed in Hayden''s Indiana church. Can''t find official name, but some call it "Are you coming to the chapel," presumably due to the Twitter video caption. Also seen called Scarlet Letter, which seems more fitting'),
...
('Powerline Valley (corrupted version)',473,'2021-07-15',NULL,1,'powerline_corrupted.jpg','Sounds like it was from a livestream or something? Only can really find this one soundcloud'),
('Givenchy FW22 Score',129,'2022',NULL,1,'Givenchy_2.png','Allegedly is a score Hayden made for Givenchy fashion week 2022. Got from "White Silas" alleged Soundcloud (prolly just a fan that took over the account).'),
...
('Michelle Pfeiffer (Solo Version)',275,'2021-04-23',2,1,'Inbred.jpg','Released on Inbred CD (check date)'),
('Unknown Song / Football*',165,NULL,NULL,1,'football.jpg','NO CLUE WHERE IT CAME FROM????? Even people on Lanaboards seemily don''t know the source??????? Could potentially be the first track to actually leak??????'),
('there''s something wrong with me (demo)',217,'2021-11-08',NULL,1,'','From livestream, probably old cuz she says "young Ethel on the track", longer title is "but he doesn''t know it yet" added as well (date is livestream date)'),
...
('Paris',216,'2018',NULL,3,'Paris.png','File was titled "Atlas (White Silas) - Paris" so unsure which era / alias it''s under. Also have no clue where it came from'),
('western nights (demo)',449,'2018-08-28',NULL,2,'','Youtube'),
('i keep the angel',166,'2024-04-21',NULL,1,'','Posted with the caption "i keep the angel" with video from Reflecting Skin. Someone asked what song it is and she responded with: "🙂‍↔️"'),
('2024 Story Snippet',24,'2024-04-20',NULL,1,'','She posted video of this snippet playing in the background with no context out of nowhere'),
...
('Stoker',43,'2022',NULL,1,'','Allegedly posted to her story August 2022, & this video is screen recording of her story with lyrics. Unsure what the song is actually called'),
('Rabid (Nicole Dollanganger Cover)',31,'2018-05-15',NULL,2,'','papermassacred insta (she said full thing was on Soundcloud, but that Soundcloud didn''t exist by the time I saw it)'),
...
Allegedly from April 23 2018 according to Lanaboards'),
('drain me',213,'2019-02-14',NULL,8,'drain_me.jpg','On Spotify it''s under White Silas, but on Soundcloud it says ft. Ethel??'),
('tentillforever',200,'2021-05-28',NULL,16,'tentillforever.jpg','"first song w michael, v excited to make more w him :) i feel like i haven’t recorded smth acoustic in almost 2 years…. didn’t realize how much i missed it </3"'),
